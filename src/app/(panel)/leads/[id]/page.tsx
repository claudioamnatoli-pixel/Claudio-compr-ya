...
export default async function LeadPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Un vendedor sólo abre sus prospectos y los que están sin asignar.
  const propio = !lead.vendedorId || lead.vendedorId === usuario.id;
  if (!propio && !puede(usuario.rol, 'leads.verTodos')) redirect(inicioDe(usuario.rol));
            ...
            <div className="p-5">
              <Formulario accion={actualizarLead} textoBoton="Guardar cambios">
                ...
                <div className="space-y-4">
                  ...
                  {puede(usuario.rol, 'leads.verTodos') ? (
